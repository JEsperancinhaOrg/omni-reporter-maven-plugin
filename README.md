...
| useCoverallsCount        | By default it is set to `false`. If you want to let coveralls determine the numbering for your Job Id and run, then set this to `true`. In this case run will always be 1 and the run will increment with Coveralls counter.                                                                                                                    | 0.0.3                  |
